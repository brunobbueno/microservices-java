package com.ms.application.bank.gateway.http;

import com.ms.application.bank.gateway.json.PagamentoJson;
import com.ms.application.bank.gateway.json.RetornoJson;
import com.ms.application.bank.service.pagamento.PagamentoService;
...
public class PagamentoController {
    ...
    public ResponseEntity<RetornoJson> pagamento(@RequestBody PagamentoJson pagamentoJson) {
